#ifndef PARSEMATERIAL_H_
#define PARSEMATERIAL_H_
...
enum 
{
	...
	ID_GPU_PROGRAM_REF,
	ID_VERTEX_SHADER_REF ,
	ID_FRAGMENT_SHADER_REF,
	ID_GEOMETRY_SHADER_REF,
	ID_COMPUTE_SHADER_REF,
	ID_GPU_PROGRAM,
	...
	ID_PARAM_INDEXED,
	ID_PARAM_NAMED,
	ID_PARAM_NAMED_UNIFORM_BLOCK,
	ID_PARAM_INDEXED_AUTO,
	ID_PARAM_NAMED_AUTO,
	ID_PARAM_NAMED_UNIFORM_BLOCK_AUTO,
...
{
public:
	static void InitPaser();
	static BWMaterial* ParseMaterial(BWDataStream &dataStream, const std::string &groupName);
	
	static bool ParseTechnique(BWDataStream &dataStream, BWTechnique* technique);
	static bool ParsePass(BWDataStream &dataStream, BWPass *pass);
	
	static bool ParseTextureUnitState(BWDataStream &dataStream, BWTextureUnitState *textureUnitState);
	static bool ParseProgram(BWDataStream &dataStream ,const std::string &name ,const std::string &language , unsigned int shaderType ,const std::string &groupName);
	static bool ParseParameter(BWDataStream &dataStream, BWGpuProgramParametersPtr parameter);
	static bool parseGPUProgram(BWDataStream &dataStream , BWHighLevelGpuProgramPtr gpuProgram);
	static bool parseGPUProgram(BWDataStream &dataStream, const std::string goupName);
};
#endif
