...
public:
	...
	*/
	static PixelFormat getFormatForBitDepths(PixelFormat fmt, unsigned short integerBits, unsigned short floatBits);
	...
	*/
	...
	@param dest		Destination memory location
	*/
	static void packColour(const unsigned char r, const unsigned char g, const unsigned char b, const unsigned char a, const PixelFormat pf, void* dest);
	/** Pack a colour value to memory
	...
	*/
	...
	point formats.
	*/
	static void unpackColour(unsigned char *r, unsigned char *g, unsigned char *b, unsigned char *a, PixelFormat pf, const void* src);
	/** Unpack a colour value from memory
	...
	*/
	static void bulkPixelConversion(const BWPixelBox &src, const BWPixelBox &dst);
};
