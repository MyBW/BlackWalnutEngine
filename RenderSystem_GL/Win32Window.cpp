...
bool WIn32Window::InitWindow()
{
	...
	BaseColorTexture = GBuffer->getTextureBuffer("BaseColorMap");
	NormalTexture = GBuffer->getTextureBuffer("NormalMap");
	PositionTexture = GBuffer->getTextureBuffer("PositionMap");
